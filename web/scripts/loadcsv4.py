...
df = pd.read_csv("/Users/jessy/Downloads/TSLA.csv",sep=',',quotechar='\'',encoding='utf8')
...
df.to_sql('qt_tsla',con=engine,index=False,if_exists='append')
